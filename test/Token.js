...
describe('Token', () => {
  ...
  describe('Sending Tokens', () => {
    ...
    describe('Success', () => {
      ...
      it('transfers token balances', async () => {
        expect(await token.balanceOf(deployer.address)).to.equal(tokens(999999900))
  ...
  describe('Delegated Token Transfers', () => {
    ...
    describe('Success', () => {
      ...
      it('transfers token balances', async () => {
        expect(await token.balanceOf(deployer.address)).to.be.equal(ethers.utils.parseUnits('999999900', 'ether'))
